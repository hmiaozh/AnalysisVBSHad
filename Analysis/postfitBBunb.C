...
void postfitBBunb(TString cat, TString ana, TString pro){

        setTDRStyle();


	TFile* f1 = TFile::Open(Form("/afs/cern.ch/user/h/hum/work/private/CMSSW_10_2_13/src/ChargedHiggs/fitDiagnosticsNanoV9FebV10unb15_2021_%s_%s_%s_unb_VVEWK.root",ana.Data(), cat.Data(),pro.Data())  );
	TFile* f2 = TFile::Open(Form("/afs/cern.ch/user/h/hum/work/private/CMSSW_10_2_13/src/ChargedHiggs/Datacards/NanoV9FebV10unb15/cms_vbshad_2021_2_%s_%s_%s.inputs.root", ana.Data(), cat.Data(), pro.Data()));
...
*/
	...
	hRatio = new TH1D("hRatio","",NBins,xbegin, xend);
        ...
        hRatio->GetYaxis()->SetRangeUser(0.15,1.95);
	...
	cout << a << "," << HhRatio->GetErrorY(a) << "shenmea" << endl;
                ...
                char Ssavepath2[150];
                char Ssavepath3[150];
		sprintf(savepath,"/afs/cern.ch/user/h/hum/work/public/CMSSW_10_2_13/src/ChargedHiggs/Analysis/plots/2022Sep/Sep11unb_newcolor_%s_%s_%s.pdf",ana.Data(),cat.Data(),pro.Data());
		sprintf(Ssavepath2,"/afs/cern.ch/user/h/hum/work/public/CMSSW_10_2_13/src/ChargedHiggs/Analysis/plots/2022Sep/Sep11unb_newcolor_%s_%s_%s.png",ana.Data(),cat.Data(),pro.Data());
		sprintf(Ssavepath3,"/afs/cern.ch/user/h/hum/work/public/CMSSW_10_2_13/src/ChargedHiggs/Analysis/plots/2022Sep/Sep11unb_newcolor_%s_%s_%s.C",ana.Data(),cat.Data(),pro.Data());
