...
void postfitBB(TString cat, TString ana, TString pro){
	...
	TFile* f1 = TFile::Open("/afs/cern.ch/user/h/hum/work/private/CMSSW_10_2_13/src/ChargedHiggs/fitDiagnosticscarddir_2021_DNN_comb_all_VVEWK.root");
	//TFile* f1 = TFile::Open(Form("/afs/cern.ch/user/h/hum/work/private/CMSSW_10_2_13/src/ChargedHiggs/fitDiagnosticsNanoV9FebV10unb_2021_%s_%s_all_VVEWK.root",ana.Data(), cat.Data())  );
	TFile* f2 = TFile::Open(Form("/afs/cern.ch/user/h/hum/work/private/CMSSW_10_2_13/src/ChargedHiggs/Datacards/NanoV9FebV10leave/cms_vbshad_2021_2_%s_%s_SR.inputs.root", ana.Data(), cat.Data()));
        //TFile* f1 = TFile::Open(Form("/afs/cern.ch/user/h/hum/work/public/VBSHAD/CMSSW_10_2_13/src/ChargedHiggs/fitDiagnosticsNanoV9FebV5_2020_%s_%s_all_VVEWK.root",ana.Data(), cat.Data())  );

        //TFile* f2 = TFile::Open(Form("/afs/cern.ch/user/h/hum/work/public/VBSHAD/CMSSW_10_2_13/src/ChargedHiggs/Datacards/NanoV9FebV5/cms_vbshad_2020_2_%s_%s_SR.inputs.root", ana.Data(), cat.Data()));
...
*/
	...
	cout << a << "," << HhRatio->GetErrorY(a) << "shenmea" << endl;
                ...
                char Ssavepath2[150];
                char Ssavepath3[150];
		sprintf(savepath,"/afs/cern.ch/user/h/hum/work/public/CMSSW_10_2_13/src/ChargedHiggs/Analysis/plots/2022Sep/Sep18unb_newcolor_%s_%s_%s.pdf",ana.Data(),cat.Data(),pro.Data());
		sprintf(Ssavepath2,"/afs/cern.ch/user/h/hum/work/public/CMSSW_10_2_13/src/ChargedHiggs/Analysis/plots/2022Sep/Sep18unb_newcolor_%s_%s_%s.png",ana.Data(),cat.Data(),pro.Data());
		sprintf(Ssavepath3,"/afs/cern.ch/user/h/hum/work/public/CMSSW_10_2_13/src/ChargedHiggs/Analysis/plots/2022Sep/Sep18unb_newcolor_%s_%s_%s.C",ana.Data(),cat.Data(),pro.Data());
